...
export const BLOG_POSTS = [
  ...
  {
    slug: 'gasket-maker-from-photo',
    title: 'Make a Replacement Gasket from a Photo (No CAD, No Tracing by Hand)',
    excerpt: 'Turn a photo of a dead gasket into a cutting template or printable TPU gasket. Real dimensions from a sheet of paper.',
    date: '2026-07-18',
    readTime: '6 min',
    tags: ['Gaskets', 'DIY Repair', 'SVG'],
    image: '/blog/gridfinity-insert.jpg',
  },
  {
    slug: 'measure-tool-from-photo-paper',
    title: 'Measure a Tool from a Photo Using a Sheet of Paper',
    excerpt: 'Skip the calipers. Photograph any tool on a Letter or A4 sheet and get exact millimeter dimensions automatically.',
    date: '2026-07-18',
    readTime: '5 min',
